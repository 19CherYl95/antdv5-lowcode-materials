...
const productPath = `/lowcode-antd-materials@${version}/build/docs/`;
...
export default defineConfig({
  ...
  chainWebpack(memo) {
    ...
    memo.resolve.alias.set('lowcode-antd-materials', join(__dirname, '../src'));
  },
  ...
  alias: {
    ...
    'lowcode-antd-materials': join(__dirname, '../src'),
  },
  apiParser: {
    propFilter: (prop) => {
